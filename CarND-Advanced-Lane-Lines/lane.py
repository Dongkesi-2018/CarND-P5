...
def pipeline(img, m, v):
    ...
    project = obj.project_back(np.copy(undist_img))
    ...
    resize_undisort_img = resize_image(np.copy(undist_img), resize_shape, '2. Undisort')
    ...
    return debug_img, project_img, undist_img
